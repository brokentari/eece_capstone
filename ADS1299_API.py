...
# descr: This files implements the basic features required to operate the ADS1299 using the SPI port
         ...
         to process samples sent by the ADS1299. Samples recpeived are pushed to a registered callback in 
...
class ADS1299_API(object):
    ...
    """ PRIVATE
    # setupEEGMode
    # @brief setup temperature mode for data streaming
    """
    
    def setupTempMode(self):
        self.SPI_transmitByte(SDATAC)
        sleep(1)
    ...
    def setSamplingRate(self):
        ...
        self.SPI_writeSingleReg(REG_CONFIG1, 0x96)
